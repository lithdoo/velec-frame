<script lang="ts">
export  class BEMElementBinderHandler {
    constructor(
        public readonly templateId: string,
        public readonly controller: MVFileController,
        public readonly store: MVModValueStore  = controller.store,
        public readonly bem: MVModBEMStyle  = controller.bem,
    ){
    ...
    editContent(tag: BemTag) {
        const modal = MVFileController.modal(this.controller)
        const title = `CSS (${MVModBEMStyle.tagClass(tag)})`
