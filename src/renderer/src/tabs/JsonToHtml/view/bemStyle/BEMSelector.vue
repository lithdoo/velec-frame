...
export class BEMSelectorHandler {
    ...
    constructor(
        public bemStyle: JthModBEMStyle,
...
import { BemTag, JthModBEMStyle } from '../base';
...
const props = defineProps<{ bem: JthModBEMStyle }>()
const current = defineModel<BemTag | null>()


const handler = computed(() => {
    // return fixReactive(new class extends BEMSelectorHandler {
    //     bemStyle: JthModBEMStyle = props.bem
