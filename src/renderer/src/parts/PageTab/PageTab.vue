...
<template>
    <div class="frame-task-tab">
        <div class="frame-task-tab__tab-list" ref="tabList">
            <div @mousedown="() => activeTab(page.tabId)" v-for="page in tabControl.list" :class="[
                'frame-task-tab__tab-item',
                tabControl.currentId === page.tabId
        ...
        <div class="frame-task-tab__page-container" v-for="page in tabControl.list" v-show="page === currentPage">
