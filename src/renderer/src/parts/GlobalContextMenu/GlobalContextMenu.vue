...
import { PopMenuLayerHandler, PopMenuListHandler, PopMenuLayer } from '@renderer/widgets/PopMenu'
...
<template>
  <div
    class="global-context-menu__archer"
    :style="{ left: pos.x, top: pos.y }"
    ref="archerElement"
    @contextmenu="stopPropagation"
  ></div>
  <div
    v-if="pos && layer.stack[0]"
    class="global-context-menu__mask"
    @contextmenu="
      (e) => {
        stopPropagation(e)
        clear()
